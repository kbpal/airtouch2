...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0019R.styleable.FontFamilyFont);
        int i = obtainAttributes.getInt(obtainAttributes.hasValue(C0019R.styleable.FontFamilyFont_fontWeight) ? C0019R.styleable.FontFamilyFont_fontWeight : C0019R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        boolean z = 1 == obtainAttributes.getInt(obtainAttributes.hasValue(C0019R.styleable.FontFamilyFont_fontStyle) ? C0019R.styleable.FontFamilyFont_fontStyle : C0019R.styleable.FontFamilyFont_android_fontStyle, 0);
        int i2 = obtainAttributes.hasValue(C0019R.styleable.FontFamilyFont_ttcIndex) ? C0019R.styleable.FontFamilyFont_ttcIndex : C0019R.styleable.FontFamilyFont_android_ttcIndex;
        String string = obtainAttributes.getString(obtainAttributes.hasValue(C0019R.styleable.FontFamilyFont_fontVariationSettings) ? C0019R.styleable.FontFamilyFont_fontVariationSettings : C0019R.styleable.FontFamilyFont_android_fontVariationSettings);
        int i3 = obtainAttributes.getInt(i2, 0);
        int i4 = obtainAttributes.hasValue(C0019R.styleable.FontFamilyFont_font) ? C0019R.styleable.FontFamilyFont_font : C0019R.styleable.FontFamilyFont_android_font;
