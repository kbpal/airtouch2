...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public TypefaceCompatApi26Impl() {
        ...
        try {
            ...
            method = obtainAddFontFromAssetManagerMethod(obtainFontFamily);
            method2 = obtainAddFontFromBufferMethod(obtainFontFamily);
            method3 = obtainFreezeMethod(obtainFontFamily);
            method4 = obtainAbortCreationMethod(obtainFontFamily);
