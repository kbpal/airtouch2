...
public class ViewCompat {
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0019R.id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0019R.id.tag_unhandled_key_listeners, map);
            }
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0019R.id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0019R.id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0019R.id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager == null) {
                UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
                view.setTag(C0019R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
