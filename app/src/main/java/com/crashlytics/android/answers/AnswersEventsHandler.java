...
class AnswersEventsHandler implements EventsStorageListener {
        ...
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.1
            ...
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo6e(Answers.TAG, "Failed to set analytics settings data", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.2
            ...
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo6e(Answers.TAG, "Failed to disable events", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.3
            ...
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo6e(Answers.TAG, "Failed to send events files", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.4
            ...
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo6e(Answers.TAG, "Failed to enable events", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.5
            ...
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo6e(Answers.TAG, "Failed to flush events", e);
                }
            }
        });
    }
        ...
        Runnable runnable = new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.6
            ...
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo6e(Answers.TAG, "Failed to process event", e);
                }
            }
        };
        if (z) {
    ...
    private void executeSync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo6e(Answers.TAG, "Failed to run events task", e);
        }
    }
    ...
    private void executeAsync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo6e(Answers.TAG, "Failed to submit events task", e);
        }
    }
}
