        ...
        try {
            try {
                ...
                try {
                    ...
                    Fabric.getLogger().mo6e(CrashlyticsCore.TAG, "Error serializing user metadata.", e);
        ...
        try {
            try {
                ...
                try {
                    ...
                    Fabric.getLogger().mo6e(CrashlyticsCore.TAG, "Error deserializing user metadata.", e);
        ...
        try {
            try {
                ...
                try {
                    ...
                    e = e;
                    bufferedWriter = bufferedWriter2;
                    Fabric.getLogger().mo6e(CrashlyticsCore.TAG, "Error serializing key/value metadata.", e);
