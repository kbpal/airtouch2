...
public final class ConnectionErrorMessages {
    ...
    public static String getErrorTitle(Context context, int i) {
        ...
        if (i != 20) {
            switch (i) {
                case 1:
                    return resources.getString(C0449R.string.common_google_play_services_install_title);
                case 2:
                    return resources.getString(C0449R.string.common_google_play_services_update_title);
                case 3:
                    return resources.getString(C0449R.string.common_google_play_services_enable_title);
                case 4:
                case 6:
                    break;
                case 5:
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return errorTitle == null ? context.getResources().getString(C0449R.string.common_google_play_services_notification_ticker) : errorTitle;
    }
            ...
            if (i != 7) {
                if (i != 9) {
                    if (i != 20) {
                        switch (i) {
                            case 1:
                                return resources.getString(C0449R.string.common_google_play_services_install_text, appName);
                            case 2:
                                return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C0449R.string.common_google_play_services_wear_update_text) : resources.getString(C0449R.string.common_google_play_services_update_text, appName);
                            case 3:
                                return resources.getString(C0449R.string.common_google_play_services_enable_text, appName);
                            default:
                                switch (i) {
                                    case 16:
                                    ...
                                    case 18:
                                        return resources.getString(C0449R.string.common_google_play_services_updating_text, appName);
                                    default:
                                        return resources.getString(C0451R.string.common_google_play_services_unknown_issue, appName);
                                }
                        }
                    }
                    return zaa(context, "common_google_play_services_restricted_profile_text", appName);
                }
                return resources.getString(C0449R.string.common_google_play_services_unsupported_text, appName);
            }
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0449R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0449R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0449R.string.common_google_play_services_enable_button);
            default:
    ...
    private static String zaa(Context context, String str, String str2) {
        ...
        if (zaa == null) {
            zaa = resources.getString(C0451R.string.common_google_play_services_unknown_issue);
        }
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C0449R.string.common_google_play_services_notification_channel_name);
    }
