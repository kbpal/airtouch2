...
public class zzm {
    ...
    public static String zza(String str, zze zzeVar, boolean z, boolean z2) {
        return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", z2 ? "debug cert rejected" : "not whitelisted", str, Hex.zza(AndroidUtilsLight.zzi(CommonUtils.SHA1_INSTANCE).digest(zzeVar.getBytes())), Boolean.valueOf(z), "12451009.false");
    }
}
