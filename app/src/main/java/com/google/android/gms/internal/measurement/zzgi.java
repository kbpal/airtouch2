...
public final class zzgi extends zzza<zzgi> {
    ...
    public final int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + (zzbVar == null ? 0 : zzbVar.hashCode())) * 31;
        if (this.zzcfc != null && !this.zzcfc.isEmpty()) {
    ...
    public final int zzf() {
        ...
        if (this.zzaxb != null && this.zzaxb.length > 0) {
            int i = zzf;
            for (int i2 = 0; i2 < this.zzaxb.length; i2++) {
                zzgf zzgfVar = this.zzaxb[i2];
                if (zzgfVar != null) {
        ...
        if (this.zzaxc != null && this.zzaxc.length > 0) {
            int i3 = zzf;
            for (int i4 = 0; i4 < this.zzaxc.length; i4++) {
                zzgl zzglVar = this.zzaxc[i4];
                if (zzglVar != null) {
                    i3 += zzyy.zzb(3, zzglVar);
                }
            }
            zzf = i3;
        }
        ...
        if (this.zzaxt != null && this.zzaxt.length > 0) {
            for (int i5 = 0; i5 < this.zzaxt.length; i5++) {
                zzgd zzgdVar = this.zzaxt[i5];
                if (zzgdVar != null) {
                    zzf += zzyy.zzb(29, zzgdVar);
                }
            }
        }
        if (this.zzafz != null) {
        ...
        return this.zzayd != null ? zzf + zzut.zzc(44, this.zzayd) : zzf;
    }
