...
public final class zzbv extends zzah {
    ...
    @VisibleForTesting
    public final zzad zzb(zzad zzadVar, zzh zzhVar) {
        boolean z = false;
    ...
    public final byte[] zza(zzad zzadVar, String str) {
        ...
        try {
            ...
            this.zzamz.zzgo().zzjk().zzd("Log and bundle processed. event, size, time_ms", this.zzamz.zzgl().zzbs(zzadVar.name), Integer.valueOf(bArr.length), Long.valueOf((this.zzamz.zzbx().nanoTime() / 1000000) - nanoTime));
            return bArr;
