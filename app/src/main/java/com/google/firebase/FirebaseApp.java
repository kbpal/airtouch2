...
public class FirebaseApp {
    ...
    private FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.zzl = new zzf(zzh, Component.C04611.zza(context).zza(), Component.of(context, Context.class, new Class[0]), Component.of(this, FirebaseApp.class, new Class[0]), Component.of(firebaseOptions, FirebaseOptions.class, new Class[0]));
