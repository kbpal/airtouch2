...
public final class Component<T> {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C04611<T> {
        private final T zza;
        private final zze<T> zzb;

        public static C04611<Context> zza(Context context) {
            return new C04611<>(context, new zzd((byte) 0));
        }

        @VisibleForTesting
        private C04611(T t, zze<T> zzeVar) {
            this.zza = t;
            this.zzb = zzeVar;
        }
