...
public class IdManager {
    ...
    public IdManager(Context context, String str, String str2, Collection<Kit> collection) {
        ...
        if (!this.collectHardwareIds) {
            ...
            logger.mo9d(Fabric.TAG, "Device ID collection disabled for " + context.getPackageName());
        }
        ...
        logger2.mo9d(Fabric.TAG, "User information collection disabled for " + context.getPackageName());
    }
