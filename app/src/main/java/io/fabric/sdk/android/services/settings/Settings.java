...
public class Settings {
    ...
    public SettingsData awaitSettingsData() {
        try {
            ...
            Fabric.getLogger().mo7e(Fabric.TAG, "Interrupted while waiting for settings data.");
            return null;
        }
    }
    ...
    public synchronized boolean loadSettingsSkippingCache() {
        ...
        if (loadSettingsData == null) {
            Fabric.getLogger().mo6e(Fabric.TAG, "Failed to force reload of settings from Crashlytics.", null);
        }
        return loadSettingsData != null;
    }
